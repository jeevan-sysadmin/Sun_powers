...
interface ComptosunDetailModalProps {
  battery: Battery;
  onClose: () => void;
...
const ComptosunDetailModal: React.FC<ComptosunDetailModalProps> = ({
  battery,
  onClose,
  getBatteryTypeColor,
  getConditionColor,
  ...
  const claimColor = getClaimColor(battery.claim_type || 'comptosun');
                ...
                <div className="detail-item" style={{ padding: '8px 0', borderBottom: '1px solid #f1f5f9' }}>
                  ...
                  <span>
                    <span style={{
                      ...
                      <ClaimIcon size={12} />
                      {(battery.claim_type || 'comptosun').toUpperCase()}
                    </span>
                  </span>
                </div>
                <div className="detail-item" style={{ padding: '8px 0', borderBottom: '1px solid #f1f5f9' }}>
                ...
                <div style={{ position: 'relative', paddingBottom: '24px' }}>
                  ...
                  <div style={{
                    ...
                    <span style={{ display: 'block', fontSize: '12px', color: '#64748b' }}>
                      Company to Sun battery was registered in the inventory
                    </span>
                  </div>
                </div>
  ...
  return (
    ...
    >
      <motion.div 
        className="modal-content comptosun-detail-modal"
      ...
      >
          ...
          <div className="header-left" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              ...
              <p style={{ 
                ...
                Company to Sun Battery Details
              </p>
            </div>
          </div>
        ...
        <div className="claim-banner" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'white' }}>
            ...
            <span style={{ fontWeight: '500' }}>COMPANY TO SUN CLAIM</span>
          </div>
          <div style={{
            ...
            Claim Type: {(battery.claim_type || 'comptosun').toUpperCase()}
          </div>
        </div>
        ...
        <div className="modal-footer" style={{
          ...
          <div className="footer-info" style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '12px', color: '#64748b' }}>
            ...
            <span style={{ color: claimColor }}>Claim: {(battery.claim_type || 'comptosun').toUpperCase()}</span>
          </div>
...
export default ComptosunDetailModal;
