...
interface SuntocompDetailModalProps {
  battery: Battery;
  onClose: () => void;
...
const SuntocompDetailModal: React.FC<SuntocompDetailModalProps> = ({
  battery,
  onClose,
  getBatteryTypeColor,
  getConditionColor,
  ...
  const claimColor = getClaimColor(battery.claim_type || 'suntocomp');
    ...
    <div className="modal-mobile-tabs" style={{
      ...
      <button
        ...
        style={{
          padding: '8px 4px',
          border: 'none',
          background: activeTab === 'details' ? '#f59e0b' : 'transparent',
          borderRadius: '8px',
          fontSize: '11px',
          fontWeight: '500',
      ...
      <button
        ...
        style={{
          padding: '8px 4px',
          border: 'none',
          background: activeTab === 'specs' ? '#f59e0b' : 'transparent',
          borderRadius: '8px',
          fontSize: '11px',
          fontWeight: '500',
          ...
          <div className="modal-tab-content">
            ...
            <div className="detail-section" style={{ marginBottom: '16px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(2, 1fr)', gap: '12px' }}>
                <div className="detail-item" style={{ padding: '8px 0', borderBottom: '1px solid #f1f5f9' }}>
                  ...
                  <span style={{ color: '#f59e0b', fontWeight: '600', fontSize: '14px' }}>{battery.battery_code || 'N/A'}</span>
                </div>
                <div className="detail-item" style={{ padding: '8px 0', borderBottom: '1px solid #f1f5f9' }}>
            ...
            <div className="detail-section" style={{ marginBottom: '16px' }}>
              <h3 style={{
                ...
                <FiTruckIcon size={isMobile ? 16 : 18} /> Claim Information
              </h3>
              <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(2, 1fr)', gap: '12px' }}>
                <div className="detail-item" style={{ padding: '8px 0', borderBottom: '1px solid #f1f5f9' }}>
                  ...
                  <span>
                    <span style={{
                      ...
                      <ClaimIcon size={12} />
                      {(battery.claim_type || 'suntocomp').toUpperCase()}
                    </span>
                  </span>
                </div>
                <div className="detail-item" style={{ padding: '8px 0', borderBottom: '1px solid #f1f5f9' }}>
                ...
                <div className="detail-item" style={{ padding: '8px 0', borderBottom: '1px solid #f1f5f9' }}>
                  ...
                  <span style={{ display: 'flex', alignItems: 'center', gap: '4px', color: '#1e293b', fontWeight: '500' }}>
                    <FiTool size={12} style={{ color: '#f59e0b' }} />
            ...
            <div className="detail-section" style={{ marginBottom: '16px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: '12px' }}>
                ...
                <div className="detail-item" style={{ padding: '8px 0', borderBottom: '1px solid #f1f5f9' }}>
                  ...
                  <span style={{ color: '#8B5CF6', fontWeight: '600' }}>{battery.company_stock_quantity || '0'}</span>
                </div>
                <div className="detail-item" style={{ padding: '8px 0', borderBottom: '1px solid #f1f5f9' }}>
                ...
                <div style={{ position: 'relative', paddingBottom: '24px' }}>
                  ...
                  <div style={{
                    ...
                    <span style={{ display: 'block', fontSize: '12px', color: '#64748b' }}>
                      Sun to Company battery was registered in the inventory
                    </span>
                  </div>
                </div>
  ...
  return (
    ...
    >
      <motion.div 
        className="modal-content suntocomp-detail-modal"
      ...
      >
          ...
          <div className="header-left" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div>
              ...
              <p style={{ 
                ...
                Sun to Company Battery Details
              </p>
            </div>
          </div>
        ...
        <div className="claim-banner" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'white' }}>
            <FiPackage size={isMobile ? 16 : 18} />
            <span style={{ fontWeight: '500' }}>SUN TO COMPANY CLAIM</span>
          </div>
          <div style={{
            ...
            Claim Type: {(battery.claim_type || 'suntocomp').toUpperCase()}
          </div>
        </div>
        ...
        {/* Modal Footer - Only Close button remains */}
        <div className="modal-footer" style={{
          ...
          <div className="footer-info" style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '12px', color: '#64748b' }}>
            ...
            <span style={{ color: claimColor }}>Claim: {(battery.claim_type || 'suntocomp').toUpperCase()}</span>
          </div>
...
export default SuntocompDetailModal;
